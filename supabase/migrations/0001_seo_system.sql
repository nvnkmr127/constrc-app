...
CREATE TABLE IF NOT EXISTS public.seo_settings (
  ...
  site_name              TEXT DEFAULT 'Screw Wood',
  site_url               TEXT DEFAULT 'https://www.screwwood.in',
  default_title_template TEXT DEFAULT '%s | Screw Wood',
  default_meta_desc      TEXT DEFAULT 'Turnkey house construction & luxury interiors in HBR Layout, Bengaluru. Transparent pricing, 415+ quality checks & 10-15 years warranty.',
  default_og_image       TEXT DEFAULT 'https://www.screwwood.in/og-default.jpg',
  business_name          TEXT DEFAULT 'Screw Wood',
  ...
  email                  TEXT DEFAULT 'reachus@screwwood.in',
...
INSERT INTO public.seo_settings (
  ...
  1,
  'Screw Wood',
  'https://www.screwwood.in',
  '%s | Screw Wood',
  'Turnkey house construction & luxury interiors in HBR Layout, Bengaluru. Transparent pricing, 415+ quality checks & 10-15 years structural warranty.',
  'https://www.screwwood.in/og-default.jpg',
  'Screw Wood',
