...
export const staticLocalSeoPages: Record<string, LocalSeoPageConfig> = {
  'construction-company-bangalore': {
    ...
    content: [
      'Screw Wood is Bangalore’s premier construction & interior design firm, offering end-to-end residential and commercial building solutions. Located at HBR Layout 5th Block, our experienced team of structural engineers, architects, and project managers deliver A-Grade quality construction within strict timelines.',
  ...
  'construction-company-hbr-layout': {
    ...
    content: [
      'Operating directly from our Experience Center on 38th Cross Rd, HBR Layout 5th Block, Screw Wood specializes in luxury residential villas and independent multi-story homes tailored for HBR Layout plot sizes.',
  ...
  'interior-designers-hbr-layout': {
    ...
    content: [
      'Transform your apartment or villa with custom interior design solutions from Screw Wood. Visit our HBR Layout Experience Center to explore material samples, marine-ply finishes, and hardware collections.',
  ...
  'house-construction-indiranagar': {
    ...
    content: [
      'Indiranagar homeowners trust Screw Wood for luxury villa construction, vertical expansion, and modern interior redesigns.',
