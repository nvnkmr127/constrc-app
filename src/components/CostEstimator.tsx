      ...
      <div className="max-w-7xl mx-auto px-4 space-y-10">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-3">
          <span className="inline-block px-4 py-1.5 rounded-full bg-orange-100 border border-orange-200 text-primary-orange text-xs font-black uppercase tracking-widest">
            ⚡ Official Screw Wood Construction Estimator
          </span>
          <h2 className="text-3xl md:text-5xl font-black text-slate-900 tracking-tight leading-tight">
            Calculate Construction Cost &amp; Home Loan EMI
          </h2>
          <p className="text-slate-600 text-sm md:text-base font-medium">
            Based on official Screw Wood package specifications &amp; BUA charging factors for Bengaluru.
          </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            {/* STEP 3: Screw Wood Package Selector & Material Specifications */}
            {step === 3 && (
              <div className="space-y-6 animate-fade-in">
                <div className="bg-white rounded-3xl p-6 md:p-8 border border-slate-200/80 shadow-sm space-y-6">
                  <div className="flex items-center justify-between border-b border-slate-100 pb-4">
                    <div>
                      <h3 className="text-xl font-black text-slate-900">👑 Screw Wood Construction Packages</h3>
                      <p className="text-xs text-slate-500">
