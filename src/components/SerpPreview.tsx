...
export default function SerpPreview({
  ...
  const displayTitle = title.trim() || 'Page Title — Screw Wood';
  ...
  const displayUrl = url.trim() || 'https://www.screwwood.in';
      ...
      >
        ...
        <div className="flex items-center gap-2 mb-1.5 text-xs text-[#202124]">
          ...
          <div className="truncate">
            <span className="font-semibold text-slate-900 block leading-tight text-[12px]">Screw Wood</span>
