...
export default function ConsentBanner() {
  ...
  useEffect(() => {
    ...
    const choice = localStorage.getItem('screwwood_consent_status');
    if (!choice) {
      setShowBanner(true);
    }
  }, []);
  ...
  const handleAcceptAll = () => {
    localStorage.setItem('screwwood_consent_status', 'granted');
  ...
  const handleRejectAll = () => {
    localStorage.setItem('screwwood_consent_status', 'denied');
    setShowBanner(false);
  };
