    ...
    <div className="relative font-sans bg-black">
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-4 -mb-32">
        <div className="bg-[#111111] text-white rounded-[32px] md:rounded-[40px] p-8 md:p-14 border border-white/10 shadow-2xl overflow-hidden relative">
          <div className="absolute top-0 right-0 w-96 h-96 bg-[#f2bd19]/10 blur-3xl rounded-full pointer-events-none" />

          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative z-10">
            <div className="lg:col-span-8 space-y-4 text-center lg:text-left">
              <span className="inline-block px-4 py-1.5 rounded-full bg-[#f2bd19]/20 border border-[#f2bd19]/40 text-[#f2bd19] text-xs font-black uppercase tracking-widest">
            ...
            <div className="lg:col-span-4 flex flex-col sm:flex-row lg:flex-col gap-3">
              <Link
                ...
                className="w-full bg-[#f2bd19] hover:bg-amber-500 text-slate-900 font-black text-xs md:text-sm uppercase tracking-wider py-4 px-6 rounded-2xl shadow-lg hover:shadow-amber-500/20 transition-all flex items-center justify-center gap-2"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12 mb-16">
            ...
            <div className="col-span-1 space-y-4">
              ...
              <div className="flex items-center gap-3 pt-2">
                ...
                <a
                  ...
                  aria-label="Facebook"
                  className="w-10 h-10 rounded-2xl bg-white/5 hover:bg-[#f2bd19] hover:text-slate-900 text-gray-300 flex items-center justify-center transition-all shadow-sm"
                >
            ...
            <div className="border-b md:border-none border-white/10 pb-4 md:pb-0">
              ...
              >
                ...
                <span className="md:hidden text-[#f2bd19] font-black text-lg">
                  {openSection === 'links' ? '−' : '+'}
                </span>
              </button>
              <ul className={`space-y-3.5 text-sm font-medium transition-all ${openSection === 'links' ? 'block' : 'hidden md:block'}`}>
                <li>
                  <Link href="/" className="hover:text-[#f2bd19] transition-colors">
                    Home
                  </Link>
                </li>
                <li>
                  <Link href="/ai-house-construction-calculator" className="text-[#f2bd19] font-bold hover:underline transition-colors">
                    AI Construction Calculator
                  </Link>
                </li>
                <li>
                  <Link href="/how-it-works" className="hover:text-[#f2bd19] transition-colors">
                    How It Works
                  </Link>
                </li>
                <li>
                  <Link href="/services" className="hover:text-[#f2bd19] transition-colors">
                    Construction Packages
                  </Link>
                </li>
                <li>
                  <Link href="/projects" className="hover:text-[#f2bd19] transition-colors">
                    Our Projects
                  </Link>
                </li>
                <li>
                  <Link href="/news" className="hover:text-[#f2bd19] transition-colors">
                    News &amp; Articles
                  </Link>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className={`space-y-4 text-xs transition-all ${openSection === 'office' ? 'block' : 'hidden md:block'}`}>
                ...
                <li className="flex items-start gap-3 group">
                  <div className="w-8 h-8 rounded-full bg-[#f2bd19]/15 border border-[#f2bd19]/40 text-[#f2bd19] flex items-center justify-center shrink-0 mt-0.5 group-hover:bg-[#f2bd19] group-hover:text-slate-900 transition-all shadow-sm">
                ...
                <li className="flex items-center gap-3 group">
                  <div className="w-8 h-8 rounded-full bg-[#f2bd19]/15 border border-[#f2bd19]/40 text-[#f2bd19] flex items-center justify-center shrink-0 group-hover:bg-[#f2bd19] group-hover:text-slate-900 transition-all shadow-sm">
                  ...
                  <div className="space-y-0.5">
                    ...
                    <a
                      ...
                      className="text-sm font-extrabold text-white group-hover:text-[#f2bd19] transition-colors block"
                    >
                      +91 9014303409
                    </a>
                  </div>
