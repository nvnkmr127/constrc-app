...
export async function GET(request: Request) {
  try {
    ...
    const title = searchParams.get('title') || 'Screw Wood — Turnkey House Construction';
        ...
        >
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <span style={{ fontSize: '28px', fontWeight: 900, letterSpacing: '-0.5px' }}>SCREW WOOD</span>
            </div>
          ...
          >
            <div style={{ display: 'flex', gap: '24px' }}>
              ...
              <span>✉️ reachus@screwwood.in</span>
            </div>
            <span style={{ color: '#f2bd19', fontWeight: 700 }}>https://www.screwwood.in</span>
          </div>
        </div>
      ),
      {
