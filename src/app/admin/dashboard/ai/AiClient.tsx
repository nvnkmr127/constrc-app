...
export default function AiClient() {
  ...
  const [testContent, setTestContent] = useState(
    `## Turnkey House Construction in HBR Layout Bangalore\n\nScrew Wood delivers 10-year structural guaranteed residential house construction in HBR Layout 5th Block, Bengaluru.\n\n### Why Choose Screw Wood?\n\nOur team of structural engineers handles BBMP approvals, soil testing, excavation, and luxury interior design within 45 days.`
  );
  const [testTitle, setTestTitle] = useState('Turnkey House Construction HBR Layout');
