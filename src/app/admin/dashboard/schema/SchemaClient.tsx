...
export default function SchemaClient() {
  ...
  const [faqItems, setFaqItems] = useState<Array<{ question: string; answer: string }>>([
    { question: 'What structural warranty does Screw Wood provide?', answer: 'We provide a 10-15 year structural warranty on all turnkey house constructions.' },
  ]);
    ...
    if (type === 'FAQPage') {
      ...
      const template = {
        ...
        publisher: {
          ...
          logo: {
            '@type': 'ImageObject',
            url: 'https://www.screwwood.in/og-default.jpg',
          },
        },
      };
      setJsonText(JSON.stringify(template, null, 2));
        ...
        itemListElement: [
          {
            ...
            position: 1,
            name: 'Home',
            item: 'https://www.screwwood.in',
          },
          {
            '@type': 'ListItem',
            position: 2,
            name: 'Services',
            item: 'https://www.screwwood.in/services',
          },
        ],
      };
      setJsonText(JSON.stringify(template, null, 2));
