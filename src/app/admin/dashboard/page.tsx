...
export default function AdminDashboardPage() {
  ...
  const [blogAuthor, setBlogAuthor] = useState('Screw Wood Team');
  ...
  const exportLeadsCsv = () => {
    ...
    link.setAttribute('download', `screwwood_leads_${new Date().toISOString().split('T')[0]}.csv`);
                  ...
                  <form onSubmit={handleSavePageSeo} className="space-y-6">
                    <YoastSeoAnalyzer
                      seoState={{
                        ...
                        content: 'Turnkey house construction and interior design services in Bangalore.',
                        ogImage: '/images/bangalore_hero_building.png',
                        canonicalUrl: `https://screwwood.com/${selectedSeoPageSlug}`,
