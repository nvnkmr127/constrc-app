...
export default function SettingsClientForm() {
  ...
  const [formData, setFormData] = useState<SeoSettings>({
    id: 1,
    site_name: 'Screw Wood',
    site_url: 'https://www.screwwood.in',
    default_title_template: '%s | Screw Wood',
    default_meta_desc:
    ...
    default_og_image: 'https://www.screwwood.in/og-default.jpg',
    business_name: 'Screw Wood',
  ...
  useEffect(() => {
    const token = localStorage.getItem('screwwood_admin_token');
    if (!token) {
      router.push('/admin');
    } else {
    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans pb-16">
      ...
      <header className="bg-slate-900 border-b border-slate-800 sticky top-0 z-30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
          ...
          <button
            onClick={() => {
              localStorage.removeItem('screwwood_admin_token');
              router.push('/admin');
            }}
              ...
              <div className="space-y-4">
                ...
                {['instagram', 'facebook', 'youtube', 'pinterest', 'linkedin'].map((platform) => (
                  <div key={platform}>
                    ...
                    <input
                      type="url"
                      placeholder={`https://www.${platform}.com/screwwood`}
