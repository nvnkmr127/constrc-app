...
export default function PagesSeoClient() {
  ...
  const [formData, setFormData] = useState<SeoMeta>({
    ...
    meta_desc: '',
    canonical_url: '',
    focus_keyword: 'house construction bangalore',
    index: true,
    follow: true,
    og_title: '',
    og_desc: '',
  ...
  const handleSelectPath = async (path: string) => {
    ...
    if (res.ok && res.data) {
      ...
      setFormData({
        ...
        title: '',
        meta_desc: '',
        canonical_url: `https://www.screwwood.in${path === '/' ? '' : path}`,
        focus_keyword: '',
        index: true,
        follow: true,
        og_title: '',
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            <SerpPreview
              ...
              url={formData.canonical_url || `https://www.screwwood.in${selectedPath === '/' ? '' : selectedPath}`}
            ...
            <form onSubmit={handleSave} className="bg-slate-900 border border-slate-800 rounded-3xl p-6 md:p-8 space-y-6 shadow-2xl">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div>
                  ...
                  <input
                    type="url"
                    placeholder={`https://www.screwwood.in${selectedPath}`}
              ...
              <div>
                ...
                <input
                  type="text"
                  placeholder="e.g. House Construction in Bangalore | Screw Wood"
              ...
              <div className="space-y-4 pt-4 border-t border-slate-800">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      placeholder="https://www.screwwood.in/images/og-share.jpg"
