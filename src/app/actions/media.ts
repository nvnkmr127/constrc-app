...
const STATIC_IMAGE_REGISTRY: ImageSeoItem[] = [
  {
    ...
    alt_text: 'Screw Wood Turnkey House Construction Site in HBR Layout Bangalore',
    in_sitemap: true,
  },
  {
  ...
  },
  {
    ...
    alt_text: 'Luxury modular kitchen and living room interior design by Screw Wood',
    in_sitemap: true,
  },
  {
